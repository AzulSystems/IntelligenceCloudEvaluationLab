...
4. Run Petclinic and onboard it into AIC using your non-Azul JDK: run the **runWithAICNonAzul** script and verify that Petclinic comes up at localhost:8080 and that your second Petclinic instance is there in the AVD UI
